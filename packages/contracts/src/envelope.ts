...
export type PaginatedEnvelope<T> = { ok: true; data: T[]; pagination: { has_more: boolean; total_count: number; next_cursor?: string | null } };
export type ErrorEnvelope = { ok: false; error: { code: string; message: string; details?: unknown[] } };
